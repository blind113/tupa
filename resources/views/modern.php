<?php
if (isset($_POST['classe_menu'])) {
    $classe_menu = $_POST["classe_menu"];
}else{
 	$classe_menu = "page-header-fixed pace-done compact-menu";
};
...
<html>
    <head>
        ...
        <!-- Theme Styles -->
        <link href="assets/css/modern_caixa.css" rel="stylesheet" type="text/css"/>
        <link href="assets/css/themes/caixa.css" class="theme-color" rel="stylesheet" type="text/css"/>
     ...
     <form id="myForm" action="modern.php" method="post">
		
    <body id="menu_pai" class='<?php echo $classe_menu; ?>'>
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="sidebar-pusher">
                        <a href="#" class="waves-effect waves-button waves-classic push-sidebar">
                            <i class="fa fa-bars"></i>
                        </a>
                    </div>
                    <div class="logo-box">
                        <a href="index.html" class="logo-text"><span><img src="assets/images/logo_branca.png" alt="" width=" "></span></a>
                    </div><!-- Logo Box -->
                    ...
                    <div class="topmenu-outer">
                        <div class="top-menu">
                            <ul class="nav navbar-nav navbar-left">
                                ...
                                <li>        
                                    <div style="color: #fff; font-weight: 300; font-size: 20px; padding-top: 15px;">SIFAC - Sistema Fala Comigo</div>
                                </li>                                
                                <!--
                                <li>
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        <li class="active"><a href="javascript:trocarMenu('modern.php');" class="waves-effect waves-button;"><span class="menu-icon glyphicon glyphicon-home"></span><p>Dashboard</p></a></li>

                        <li><a href="javascript:trocarMenu('profile.php');" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-user"></span><p>Profile</p></a></li>
            ...
            <div class="page-inner">
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="trocarMenu('index.html')">Home</a></li>
		...
		<script src="assets/js/pages/caixa.js"></script>
